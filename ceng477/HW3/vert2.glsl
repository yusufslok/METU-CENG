...
vec3 kd = vec3(0.9, 0.05, 0.05);     // diffuse reflectance coefficient
vec3 ka = vec3(0.3, 0.3, 0.3);   // ambient reflectance coefficient
vec3 ks = vec3(0.9, 0.5, 0.5);   // specular reflectance coefficient
vec3 lightPos = vec3(0, 5, 5);   // light position in world coordinates
